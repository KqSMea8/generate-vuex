<template>
  <div style="height: 100%">
    <nv-head page-type="消息" :fix-head="true" :show-menu="showMenu" :message-count="no_read_len" :need-add="true"></nv-head>
    <div class="page">
      <ul class="tabs">
...
export default {
  ...
  mounted() {
    $.get(
      "https://cnodejs.org/api/v1/messages?accesstoken=" + this.userInfo.token,
      d => {
        if (d && d.data) {
          this.message = d.data;
